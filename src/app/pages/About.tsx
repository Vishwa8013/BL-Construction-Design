    ...
    <div style={{ backgroundColor: "#0F172A" }}>
      ...
      >
        ...
        <h1 style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 800, fontSize: "clamp(2.5rem, 6vw, 4.5rem)", color: "white", lineHeight: 1.1, marginBottom: "1.25rem" }}>
          About <span style={{ color: "#FBBF24" }}>BL Construction and Design</span>
        </h1>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="relative">
              ...
              >
                <div style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 800, fontSize: "1.8rem", color: "#0F172A", lineHeight: 1 }}>500+</div>
                <div style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.8rem", color: "#1E3A5F", fontWeight: 600 }}>Projects Built</div>
              </div>
            </div>
            <div>
              <SectionLabel>Our Story</SectionLabel>
              <h2 style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 800, fontSize: "clamp(2rem, 4vw, 2.8rem)", color: "white", lineHeight: 1.15, marginBottom: "1.5rem" }}>
                Built on Experience,<br /><span style={{ color: "#FBBF24" }}>Focused on Results</span>
              </h2>
              <p style={{ color: "#94A3B8", lineHeight: 1.8, fontFamily: "'Inter', sans-serif", marginBottom: "1.25rem" }}>
              ...
              <p style={{ color: "#94A3B8", lineHeight: 1.8, fontFamily: "'Inter', sans-serif", marginBottom: "2rem" }}>
              ...
              <div className="grid grid-cols-2 gap-6">
                {[
                  ...
                  <div key={label} className="p-5 rounded-xl" style={{ backgroundColor: "#131F35", border: "1px solid rgba(255,255,255,0.06)" }}>
                    <div style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 800, fontSize: "1.8rem", color: "#FBBF24", lineHeight: 1 }}>{val}</div>
                    <div style={{ color: "#64748B", fontFamily: "'Inter', sans-serif", fontSize: "0.85rem", marginTop: "0.25rem" }}>{label}</div>
                  </div>
                ))}
              </div>
            </div>
      ...
      {/* MISSION & VISION */}
      <section className="py-20 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: "#0B1527" }}>
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="p-10 rounded-2xl" style={{ backgroundColor: "#131F35", border: "1px solid rgba(251,191,36,0.15)" }}>
              <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-5" style={{ backgroundColor: "rgba(251,191,36,0.12)" }}>
                <Target size={26} style={{ color: "#FBBF24" }} />
              </div>
              <h3 style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 700, color: "white", fontSize: "1.5rem", marginBottom: "1rem" }}>Our Mission</h3>
              <p style={{ color: "#64748B", fontFamily: "'Inter', sans-serif", lineHeight: 1.8 }}>
            ...
            <div className="p-10 rounded-2xl" style={{ backgroundColor: "#131F35", border: "1px solid rgba(251,191,36,0.15)" }}>
              <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-5" style={{ backgroundColor: "rgba(251,191,36,0.12)" }}>
                <Eye size={26} style={{ color: "#FBBF24" }} />
              </div>
              <h3 style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 700, color: "white", fontSize: "1.5rem", marginBottom: "1rem" }}>Our Vision</h3>
              <p style={{ color: "#64748B", fontFamily: "'Inter', sans-serif", lineHeight: 1.8 }}>
          ...
          <div className="mt-16">
            <div className="text-center mb-12">
              ...
              <h2 style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 800, fontSize: "clamp(2rem, 4vw, 2.8rem)", color: "white" }}>
                Our Core <span style={{ color: "#FBBF24" }}>Values</span>
              </h2>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {VALUES.map(({ icon: Icon, title, desc }) => (
                <div key={title} className="p-7 rounded-2xl text-center" style={{ backgroundColor: "#0F172A", border: "1px solid rgba(255,255,255,0.06)" }}>
                  <div className="w-14 h-14 rounded-xl flex items-center justify-center mx-auto mb-4" style={{ backgroundColor: "rgba(251,191,36,0.12)" }}>
                    <Icon size={24} style={{ color: "#FBBF24" }} />
                  </div>
                  <h4 style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 700, color: "white", fontSize: "1rem", marginBottom: "0.75rem" }}>{title}</h4>
